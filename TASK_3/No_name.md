...
Nó trong python là tính xor chứ không phải mũ. Nên từ đó ta thấy $A = g \oplus a \text{và} B = g \oplus b \text{nên từ đó ta có} secret = A \oplus B \oplus g$. Sau khi có secret ta chỉ cần giải mã bằng hàm có sẵn là được.
