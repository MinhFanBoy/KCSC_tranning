...
p = 
c = 
...
once = gmpy2.gcd(gmpy2.powmod(2,prd ** 5,p) - 1,p)
...
tmp = [9322942235066442561655195674934627052377962367030229810213569716386005761696822841987578275939319261109157569501818659511026514045312372176737087271349863, 125985620538815547256625097785835067032194763802725645923397555122000996782987395811142376605375686141753509984412651423089866281588480073116969757037583343]
phi = (tmp[0] - 1) * (tmp[1] - 1)
print(factor(list(set(factor(phi)))))
p = 
c = 
g = 3
